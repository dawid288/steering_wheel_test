...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LD1_Pin|LD3_Pin|LD4_Pin|LD5_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = BUTTON_HORN_Pin|BUTTON_HALF_GAS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  ...
  /*Configure GPIO pins : PAPin PAPin PAPin PAPin
                           PAPin PAPin */
  GPIO_InitStruct.Pin = BUTTON_MODE1_Pin|BUTTON_MODE2_Pin|BUTTON_FUELCELL_RACE_MODE_Pin|BUTTON_FUELCELL_PREPARE_TO_RACE_MODE_Pin
                          |BUTTON_FUELCELL_OFF_MODE_Pin|BUTTON_EMERGENCY_Pin;
  ...
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(BUTTON_TIME_GPIO_Port, &GPIO_InitStruct);
